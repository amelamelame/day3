...
export default function App() 
{
  ...
  },
  {
      "id": 2,
      "name": "Ernakulam",
      "description": "Ernakulam is a major port city in Kerala famous for its stunning backwaters and vibrant culture.",
  ...
  <div class="hai">
    <h1 class="text-center"><br></br>KERALA DISTRICTS</h1>
    </div>
 <Container>
<Row>
{
...
<Card style={{height:'450px',width:'300px',border: '2px solid white',backgroundColor: '#E4FAE4'}}>
<Card.Img variant="top" src={district.image} style={{height:'200px'}}/>
<Card.Body>
...
<div class="text-center">
  <Button className='mt-5' variant="primary">Click to Know more</Button>
  </div>
